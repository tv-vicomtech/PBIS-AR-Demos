...
public class FaceManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        headBone = transform.Find("Alien").Find("rig:Hips").Find("rig:Spine").Find("rig:Spine1").Find("rig:Spine2").Find("rig:Neck").Find("rig:Head");
        lowerLid = transform.Find("AlienLowerEyeLids");
        upperLid = transform.Find("AlienUpperEyeLids");
        baseBoneL = headBone.Find("rig:AntennaLeft");
        baseBoneR = headBone.Find("rig:AntennaRight");
        ...
        if (leafBoneL == null ) leafBoneL = baseBoneL.Find("rig:AntennaLeft_end");
        ...
        if ( leafBoneR == null ) leafBoneR = baseBoneR.Find("rig:AntennaRight_end");
